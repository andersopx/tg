...
本文件整合了仓库根目录原先分散的 README、升级说明、调查记录、兼容说明和包清单。根目录现在只保留这一份项目文档，避免多个 `.md` / `.txt` 文档互相重复或版本不一致。
...
7. `PYTHON36_FIXES.md`
8. `PACKAGE_TYPE_FULL_PROJECT.txt`
9. `FULL_PACKAGE_MANIFEST_V15_1_3.txt`
10. `FULL_PROJECT_FILE_LIST.txt`
...
## 原文档：`PACKAGE_TYPE_FULL_PROJECT.txt`

```text
THIS IS THE FULL PROJECT PACKAGE FOR btc_bot_v15_1_3.
It is NOT an upgrade-only package and NOT a patch-only package.
It contains complete source files, tests, config examples, install scripts, README files, and manifests.
```


## 原文档：`FULL_PACKAGE_MANIFEST_V15_1_3.txt`

```text
.env
.env.example
.env.high_win_rate.example
INVESTIGATION_MARK_ORDER_ATTEMPT_V14_2_28.md
PYTHON36_FIXES.md
README.md
README_V15_1_3.md
UPGRADE_NOTES_V10.md
UPGRADE_NOTES_V11.md
UPGRADE_NOTES_V13_9.md
UPGRADE_NOTES_V14_0.md
UPGRADE_NOTES_V14_1.md
UPGRADE_NOTES_V14_2.md
UPGRADE_NOTES_V14_2_1.md
UPGRADE_NOTES_V14_2_16.md
UPGRADE_NOTES_V14_2_17.md
UPGRADE_NOTES_V14_2_19.md
UPGRADE_NOTES_V14_2_2.md
UPGRADE_NOTES_V14_2_20.md
UPGRADE_NOTES_V14_2_21.md
UPGRADE_NOTES_V14_2_22.md
UPGRADE_NOTES_V14_2_24.md
UPGRADE_NOTES_V14_2_25.md
UPGRADE_NOTES_V14_2_26.md
UPGRADE_NOTES_V14_2_27.md
UPGRADE_NOTES_V14_2_28.md
UPGRADE_NOTES_V14_2_29.md
UPGRADE_NOTES_V14_2_3.md
UPGRADE_NOTES_V14_2_30.md
UPGRADE_NOTES_V14_2_31.md
UPGRADE_NOTES_V14_2_32.md
UPGRADE_NOTES_V14_2_33.md
UPGRADE_NOTES_V14_2_33_DEPLOY_FIX.md
UPGRADE_NOTES_V14_2_34.md
UPGRADE_NOTES_V14_2_35.md
UPGRADE_NOTES_V14_2_36.md
UPGRADE_NOTES_V14_2_37.md
UPGRADE_NOTES_V14_2_38.md
UPGRADE_NOTES_V14_2_39.md
UPGRADE_NOTES_V14_2_40.md
UPGRADE_NOTES_V14_2_8.md
UPGRADE_NOTES_V14_3_0.md
UPGRADE_NOTES_V14_3_2.md
UPGRADE_NOTES_V15_1_2.md
UPGRADE_NOTES_V15_1_3.md
UPGRADE_NOTES_V15_HIGH_WIN_RATE.md
UPGRADE_NOTES_V3.md
UPGRADE_NOTES_V4.md
UPGRADE_NOTES_V5.md
UPGRADE_NOTES_V6.md
...
__pycache__/profit_rule_engine.cpython-313.pyc
__pycache__/telegram_bot.cpython-313.pyc
__pycache__/trader.cpython-313.pyc
adaptive_edge_engine.py
adaptive_quality_gate.py
analytics_report.py
apply_high_win_rate_mode.sh
audit_v14_3_2.sh
audit_v15_1_3.sh
auto_pipeline.py
backtest.py
binance_feed.py
clear_sensitive_data.py
config.py
data_collector.py
database.py
diagnose_live_state.py
dynamic_tick_guard.py
execution_flight_recorder.py
execution_quality_guard.py
high_win_rate_guard.py
install_current.sh
install_ready.sh
install_v14_3_2.sh
install_v15_1_3.sh
...
preflight_check.py
product_doctor.py
profit_rule_audit_v14_2_42.py
profit_rule_engine.py
realtime_orderbook.py
rebuild_profit_rules_v14_2_42.py
recompute_learning_stats_v14_2_39.py
requirements.txt
risk_manager.py
start.sh
start_high_win_rate.sh
start_py311.sh
strategy.py
strategy_weight_controller.py
telegram_bot.py
tests/conftest.py
tests/fixtures/gamma_btc_5m.json
tests/test_backtest.py
tests/test_core.py
tests/test_intelligent_review.py
tests/test_multi_asset.py
tests/test_odds_reversal.py
tests/test_quality_gate.py
tests/test_v14_1_market_ws.py
tests/test_v14_2_11_tg_doctor_ws_controls.py
tests/test_v14_2_13_tg_control_state_clarity.py
tests/test_v14_2_15_tg_noise_cleanup.py
tests/test_v14_2_16_price_to_beat_fallback.py
tests/test_v14_2_17_tg_prompt_cleanup.py
tests/test_v14_2_18_readable_reasons_assets.py
tests/test_v14_2_19_execution_thresholds.py
tests/test_v14_2_1_runtime_settings.py
tests/test_v14_2_20_token_range_diagnostics.py
tests/test_v14_2_21_readable_recent_order_lock.py
tests/test_v14_2_22_order_attempt_retry_lock.py
tests/test_v14_2_23_all_reasons_have_chinese.py
tests/test_v14_2_23_trade_lifecycle.py
tests/test_v14_2_26_barrier_reclaim_custom_gate.py
tests/test_v14_2_27_barrier_reclaim_execution_caps.py
tests/test_v14_2_29_fake_lock.py
tests/test_v14_2_2_amount_unified.py
tests/test_v14_2_31_clob_options.py
tests/test_v14_2_31_small_balance_defaults.py
tests/test_v14_2_32_no_silent_fallback.py
tests/test_v14_2_33_stability_cleanup.py
tests/test_v14_2_33_tg_ui_compact.py
tests/test_v14_2_37_orderbook_parser_guard.py
tests/test_v14_2_3_capital_isolation.py
tests/test_v14_2_4_telegram_capital_ui.py
tests/test_v14_2_5_tg_trade_keys.py
tests/test_v14_2_6_live_only_runtime_controls.py
tests/test_v14_2_7_tg_commands.py
tests/test_v14_2_8_tg_status_multifeed.py
tests/test_v14_2_product_doctor.py
tests/test_v14_stream_gate.py
tests/test_v15_1_0_profit_rule_live_gate.py
tests/test_v15_1_1_safety_gates.py
tests/test_v15_high_win_rate_guard.py
trade_reviewer.py
trader.py
ws_health_monitor.py
修复报告.md
升级完成报告.md
```


## 原文档：`FULL_PROJECT_FILE_LIST.txt`

```text
.env
.env.example
.env.high_win_rate.example
FULL_PACKAGE_MANIFEST_V15_1_3.txt
FULL_PROJECT_FILE_LIST.txt
INVESTIGATION_MARK_ORDER_ATTEMPT_V14_2_28.md
PACKAGE_TYPE_FULL_PROJECT.txt
PYTHON36_FIXES.md
README.md
README_V15_1_3.md
README_V15_1_3_FULL.md
UPGRADE_NOTES_V10.md
UPGRADE_NOTES_V11.md
UPGRADE_NOTES_V13_9.md
UPGRADE_NOTES_V14_0.md
